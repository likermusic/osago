...
export async function triggerCommunicationLoaderController(ctx: App.ExtendedContext): Promise<void> {
  ...
  ctx.response.body = await ctx.renderToHTML(APP_ROUTES.triggerCommunicationLoader);
}
