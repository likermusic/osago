...
export interface paths {
  ...
  "/v1/osago/send-sms-prolong-link": {
    /** @deprecated */
    get: {
      parameters: {
        query?: {
  ...
  "/v1/coefficients/kbm": {
    post: {
      requestBody?: {
        content: {
          "application/json-patch+json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Driver"];
          "application/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Driver"];
          "text/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Driver"];
          "application/*+json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Driver"];
        };
      };
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Kbm"];
            "application/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Kbm"];
            "text/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Kbm"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/coefficients": {
    post: {
      requestBody: {
        content: {
          "application/json-patch+json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+CoefficientsRequest"];
          "application/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+CoefficientsRequest"];
          "text/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+CoefficientsRequest"];
          "application/*+json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+CoefficientsRequest"];
        };
      };
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Coefficients"];
            "application/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Coefficients"];
            "text/json": components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+Coefficients"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/order/{orderHash}/checkpayment": {
    post: {
      parameters: {
        path: {
          orderHash: string;
      ...
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.CheckPaymentResult"];
            "application/json": components["schemas"]["Sravni.Osago.CheckPaymentResult"];
            "text/json": components["schemas"]["Sravni.Osago.CheckPaymentResult"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/orders/{orderHash}/confirmPayment": {
    post: {
      parameters: {
        path: {
          orderHash: string;
  ...
  "/v1/orders/{orderHash}/rejectPayment": {
    post: {
      parameters: {
        path: {
          orderHash: string;
  ...
  "/v1/trysaveresults/{orderHash}": {
    get: {
      ...
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.TrySaveResult"];
            "application/json": components["schemas"]["Sravni.Osago.TrySaveResult"];
            "text/json": components["schemas"]["Sravni.Osago.TrySaveResult"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/create": {
    ...
    post: {
      ...
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.Shared.Dto.ISaveResult"];
            "application/json": components["schemas"]["Sravni.Osago.Shared.Dto.ISaveResult"];
            "text/json": components["schemas"]["Sravni.Osago.Shared.Dto.ISaveResult"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/check-kbm": {
    ...
    post: {
      requestBody?: {
        content: {
          "application/json-patch+json": components["schemas"]["Sravni.Osago.Kbm.OsagoKbmRequest"];
          "application/json": components["schemas"]["Sravni.Osago.Kbm.OsagoKbmRequest"];
          "text/json": components["schemas"]["Sravni.Osago.Kbm.OsagoKbmRequest"];
          "application/*+json": components["schemas"]["Sravni.Osago.Kbm.OsagoKbmRequest"];
        };
      };
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.Kbm.KbmResult"];
            "application/json": components["schemas"]["Sravni.Osago.Kbm.KbmResult"];
            "text/json": components["schemas"]["Sravni.Osago.Kbm.KbmResult"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/orders/recommendedstartdate/{number}": {
    /** @deprecated */
    get: {
      parameters: {
        query?: {
  ...
  "/v1/orders/recommendedstartdate": {
    post: {
      requestBody?: {
        content: {
  ...
  "/v1/orders/{orderHash}/clear-cache": {
    post: {
      parameters: {
        path: {
          orderHash: string;
  ...
  "/v1/orders/{orderHash}/policydrafts": {
    /** @deprecated */
    get: {
      parameters: {
        query?: {
  ...
  "/v1/orders/{orderHash}/policyblank": {
    get: {
      parameters: {
        path: {
          orderHash: string;
  ...
  "/v1/orders/{hash}/prolongation-query": {
    post: {
      parameters: {
        path: {
          hash: string;
  ...
  "/v1/orders/{orderHash}/promo/link": {
    post: {
      parameters: {
        path: {
          orderHash: string;
  ...
  "/v1/orders/{orderHash}/promo/message": {
    get: {
      parameters: {
        path: {
          orderHash: string;
  ...
  "/v1/save-query-with-price": {
    post: {
      ...
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.SaveQueryWithPriceResult"];
            "application/json": components["schemas"]["Sravni.Osago.SaveQueryWithPriceResult"];
            "text/json": components["schemas"]["Sravni.Osago.SaveQueryWithPriceResult"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/short-prolongation": {
    post: {
      ...
      requestBody?: {
        content: {
          "application/json-patch+json": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongationQuery"];
          "application/json": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongationQuery"];
          "text/json": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongationQuery"];
          "application/*+json": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongationQuery"];
        };
      };
      responses: {
        ...
        200: {
          content: {
            "text/plain": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongation.CreateShortProlongationResponse"];
            "application/json": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongation.CreateShortProlongationResponse"];
            "text/json": components["schemas"]["Sravni.Osago.Shared.Dto.ShortProlongation.CreateShortProlongationResponse"];
          };
        };
        /** @description Bad Request */
        400: {
  ...
  "/v1/short-prolongation/test-sber": {
    post: {
      responses: {
        /** @description Success */
        200: {
...
export interface components {
  schemas: {
    ...
    "Sravni.Osago.CheckPaymentResult": {
      isPaid?: boolean;
      error?: string | null;
    ...
    "Sravni.Osago.FractionalPaymentInfo": {
      /** Format: double */
      price?: number;
      /** Format: double */
      commission?: number;
      osagoAcquiringType?: components["schemas"]["Sravni.Osago.Shared.Dto.OsagoAcquiringType"];
      paymentUrl?: string | null;
      paymentId?: string | null;
      paymentParts?: components["schemas"]["Sravni.Osago.FractionalPaymentPart"][] | null;
    };
    "Sravni.Osago.FractionalPaymentPart": {
      /** Format: double */
      paymentSum?: number;
      /** Format: date-time */
      paymentDate?: string;
    ...
    "Sravni.Osago.Kbm.KbmResult": {
      hasResult?: boolean;
      kbm?: components["schemas"]["Sravni.Osago.Kbm.KbmInfo"];
      person?: components["schemas"]["Sravni.Osago.DriverInfo"];
      /** Format: double */
      minimumPrice?: number;
      error?: string | null;
    };
    "Sravni.Osago.Kbm.OsagoKbmRequest": {
      person?: components["schemas"]["Sravni.Osago.DriverInfo"];
      driverAmount?: components["schemas"]["Sravni.Osago.DriverAmount"];
      vin?: string | null;
      bodyNumber?: string | null;
    ...
    "Sravni.Osago.SaveQueryWithPriceResult": {
      /** Format: int64 */
      id?: number;
      hash?: string | null;
      /** Format: double */
    ...
    "Sravni.Osago.Service.MockCoeffiсientsController+AgeExperience": {
      /** Format: date-time */
      birthDate?: string;
      /** Format: date-time */
    ...
    "Sravni.Osago.Service.MockCoeffiсientsController+Coefficients": {
      /** Format: double */
      kt?: number;
      /** Format: double */
      kvs?: number;
    ...
    "Sravni.Osago.Service.MockCoeffiсientsController+CoefficientsRequest": {
      ageExperiences: components["schemas"]["Sravni.Osago.Service.MockCoeffiсientsController+AgeExperience"][];
    ...
    "Sravni.Osago.Service.MockCoeffiсientsController+Driver": {
      lastName?: string | null;
      middleName?: string | null;
      firstName?: string | null;
      fullName?: string | null;
    ...
    "Sravni.Osago.Service.MockCoeffiсientsController+Kbm": {
      /** Format: double */
      value?: number;
    };
    /** @enum {string} */
    ...
    "Sravni.Osago.Shared.Dto.BackOffice.MappingError": {
      /** Format: int32 */
      errorRuleId?: number;
      online?: string | null;
      offline?: string | null;
    ...
    "Sravni.Osago.Shared.Dto.CheckResult": {
      id?: string | null;
      passed?: boolean;
    };
    ...
    "Sravni.Osago.Shared.Dto.DriverCheckResult": {
      id?: string | null;
      passed?: boolean;
      fullName?: string | null;
    };
    "Sravni.Osago.Shared.Dto.DriverKbmCalculateResult": {
      fio?: string | null;
      /** Format: date-time */
      birthDate?: string;
      /** Format: double */
    ...
    "Sravni.Osago.Shared.Dto.ISaveResult": {
      calcId?: string | null;
      vehicleCheckResult?: components["schemas"]["Sravni.Osago.Shared.Dto.VehicleCheckResult"];
      insurerCheckResult?: components["schemas"]["Sravni.Osago.Shared.Dto.CheckResult"];
      ownerCheckResult?: components["schemas"]["Sravni.Osago.Shared.Dto.CheckResult"];
      driversCheckResults?: components["schemas"]["Sravni.Osago.Shared.Dto.DriverCheckResult"][] | null;
      contractId?: string | null;
      contractNumber?: string | null;
      /** Format: double */
      price?: number;
      fractionalPaymentInfo?: components["schemas"]["Sravni.Osago.FractionalPaymentInfo"];
      url?: string | null;
      osagoAcquiringType?: components["schemas"]["Sravni.Osago.Shared.Dto.OsagoAcquiringType"];
      saveResultType?: components["schemas"]["Sravni.Osago.SaveResultType"];
      description?: string | null;
      recomendationToUser?: string | null;
      errors?: components["schemas"]["Sravni.Osago.Shared.Dto.BackOffice.MappingError"][] | null;
      provider?: components["schemas"]["Sravni.Osago.Shared.Dto.InsuranceProvider"];
      hash?: string | null;
      /** Format: int32 */
      ...
      /** Format: double */
      commission?: number;
      takePayUrlOnTheNextStep?: boolean;
      isPool?: boolean;
      isKv0?: boolean;
      isNotSegment?: boolean;
      onRetry?: boolean;
      driverKbmList?: components["schemas"]["Sravni.Osago.Shared.Dto.DriverKbmCalculateResult"][] | null;
      profit?: components["schemas"]["Sravni.Osago.PartnerProfit"];
      /** Format: date-time */
    ...
    "Sravni.Osago.Shared.Dto.ShortProlongation.CreateShortProlongationResponse": {
      /**
       * Format: int32
       * @description TaskId
       */
    ...
    "Sravni.Osago.Shared.Dto.ShortProlongationQuery": {
      insurer?: components["schemas"]["Sravni.Osago.ShortProlongationPerson"];
      /** Format: int32 */
      companyId?: number;
      platform?: string | null;
      utm?: components["schemas"]["Sravni.Osago.UtmQuery"];
    ...
    "Sravni.Osago.Shared.Dto.VehicleCheckResult": {
      id?: string | null;
      passed?: boolean;
      failedFields?: string | null;
    };
    ...
    "Sravni.Osago.ShortProlongationPerson": {
      lastName?: string | null;
      middleName?: string | null;
      firstName?: string | null;
      fullName?: string | null;
    ...
    "Sravni.Osago.TrySaveResult": {
      isCompleted?: boolean;
      searchId?: string | null;
      osagoTrySaveResults?: components["schemas"]["Sravni.Osago.TrySaveResult+OsagoTrySaveResult"][] | null;
    };
    "Sravni.Osago.TrySaveResult+OsagoTrySaveResult": {
      /** Format: int32 */
      id?: number;
      /** Format: int32 */
      trySaveId?: number;
